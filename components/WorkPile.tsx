...
const SLIDES: Slide[] = [
  ...
  { srcs: ["/depict1.webp"], company: "Depict" },
  { srcs: ["/depict2.webp"], company: "Depict" },
  { srcs: ["/depict3.webp", "/depict4.webp"], company: "Depict" },
  { srcs: ["/depict5.webp"], company: "Depict" },
  { srcs: ["/depict6.webp"], company: "Depict" },
  { srcs: ["/depictvid2.mp4"], company: "Depict" },
  { srcs: ["/zettle1.webp"], company: "Zettle" },
  { srcs: ["/zettle6.gif", "/zettle7.gif"], company: "Zettle" },
  { srcs: ["/zettle2.webp"], company: "Zettle" },
  { srcs: ["/zettle4.webp", "/zettle5.gif"], company: "Zettle" },
  { srcs: ["/zettle3.webp"], company: "Zettle" },
  { srcs: ["/brick0.webp"], company: "Brickanta" },
  { srcs: ["/brick1.webp"], company: "Brickanta" },
  { srcs: ["/brick2.webp"], company: "Brickanta" },
  { srcs: ["/brick3.webp", "/brick4.webp"], company: "Brickanta" },
  { srcs: ["/brick5.webp"], company: "Brickanta" },
  { srcs: ["/minesquad1.webp"], company: "Minesquad" },
  { srcs: ["/minesquad2.webp"], company: "Minesquad" },
  { srcs: ["/minesquad3.webp"], company: "Minesquad" },
  ...
  { srcs: ["/picto1.webp"], company: "PictoKit" },
  { srcs: ["/picto2.webp"], company: "PictoKit" },
  { srcs: ["/picto3.webp"], company: "PictoKit" },
];
